...
# Article Guide — tiang.pabrikasi.id
...
Source route evidence: sitemap XML, 7945 routes discovered during packet generation
Reader community name: `Pabrikasi.id`
...
- Address the reader warmly as `Sobat Pabrikasi.id`, `Kawan Pabrikasi.id`, or `Teman Pabrikasi.id`. Use the exact opening salutation assigned inside the article file.
