---
article_id: TPG-10-05
title: "Outreach Arm dan Bracket Lampu: Eccentricity yang Sering Terlupa"
slug: "outreach-arm-bracket-lampu"
description: "Explain outreach, orientation, mass, projected area, torsion, connections, cable route, access, and replacement compatibility"
status: outline
publication_date: "2026-02-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-10
primary_intent: "Specify lighting attachments"
reader_community: "Pabrikasi.id"
reader_address: "Kawan Pabrikasi.id"
final_route: "/artikel/outreach-arm-bracket-lampu.html"
...
# Outreach Arm dan Bracket Lampu: Eccentricity yang Sering Terlupa

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Outreach Arm dan Bracket Lampu: Eccentricity yang Sering Terlupa”
- **Reader and situation:** Designer or buyer selecting an arm arrangement
- **Reader outcome:** Explain outreach, orientation, mass, projected area, torsion, connections, cable route, access, and replacement compatibility
- **Primary intent:** Specify lighting attachments
...
- **Scope boundary:** No arm/connection dimensions or capacity without project engineering
- **Final public route:** `/artikel/outreach-arm-bracket-lampu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Outreach Arm dan Bracket Lampu: Eccentricity yang Sering Terlupa**.
...
- `/led-lighting` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/lampu-taman` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/lampu-sorot` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/lampu-solar-energy` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/lampu-jalan-pju` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Outreach Arm dan Bracket Lampu: Eccentricity yang Sering Terlupa”.
