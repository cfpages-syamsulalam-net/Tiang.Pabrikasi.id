...
title: "Dari Data Tanah ke Desain Fondasi Tiang"
slug: "data-tanah-untuk-fondasi-tiang"
description: "Explain required site model, groundwater, parameters, variability, foundation behavior, and questions between disciplines"
status: outline
publication_date: "2025-12-31"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-08
primary_intent: "Understand geotechnical-to-structural handoff"
reader_community: "Pabrikasi.id"
reader_address: "Teman Pabrikasi.id"
final_route: "/artikel/data-tanah-untuk-fondasi-tiang.html"
...
# Dari Data Tanah ke Desain Fondasi Tiang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Dari Data Tanah ke Desain Fondasi Tiang”
- **Reader and situation:** Owner reviewing a soil report and reactions
- **Reader outcome:** Explain required site model, groundwater, parameters, variability, foundation behavior, and questions between disciplines
- **Primary intent:** Understand geotechnical-to-structural handoff
...
- **Scope boundary:** Does not interpret site data into a foundation design for the reader
- **Final public route:** `/artikel/data-tanah-untuk-fondasi-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Dari Data Tanah ke Desain Fondasi Tiang**.
...
- `/jual-pasang-tiang-traffic-light-tanah-laut.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-tanah-laut` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-tanah-datar.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-tanah-datar` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-tanah-bumbu.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-tanah-bumbu` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `TPG-08-02` → `/artikel/base-plate-vs-tiang-tanam.html` — Base Plate atau Tiang Tanam: Memilih Konsep Penumpu
- `TPG-08-03` → `/artikel/anchor-bolt-template-tiang.html` — Anchor Bolt Template: Menjaga Posisi Sebelum Beton Mengeras
- `TPG-08-05` → `/artikel/grout-leveling-base-plate-tiang.html` — Grout, Leveling, dan Drainase di Bawah Base Plate Tiang
- `TPG-08-06` → `/artikel/reaction-schedule-tiang.html` — Reaction Schedule Tiang: Data yang Dibutuhkan Desainer Sipil
...
- **Tie back to this article:** Keep the explanation specific to “Dari Data Tanah ke Desain Fondasi Tiang”.
