---
article_id: TPG-10-03
title: "Tinggi Tiang dan Spacing Lampu: Mengapa Tidak Ada Angka Universal"
slug: "tinggi-dan-spacing-tiang-lampu"
description: "Explain road/area geometry, target criteria, luminaire distribution, mounting, obstructions, glare, maintenance, and iterative study"
status: outline
publication_date: "2026-02-15"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-10
primary_intent: "Understand photometric dependencies"
reader_community: "Pabrikasi.id"
reader_address: "Teman Pabrikasi.id"
final_route: "/artikel/tinggi-dan-spacing-tiang-lampu.html"
...
# Tinggi Tiang dan Spacing Lampu: Mengapa Tidak Ada Angka Universal

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tinggi Tiang dan Spacing Lampu: Mengapa Tidak Ada Angka Universal”
- **Reader and situation:** Buyer asking for a standard height/spacing
- **Reader outcome:** Explain road/area geometry, target criteria, luminaire distribution, mounting, obstructions, glare, maintenance, and iterative study
- **Primary intent:** Understand photometric dependencies
...
- **Scope boundary:** Publishes no universal spacing, height, or illuminance; qualified lighting design owns values
- **Final public route:** `/artikel/tinggi-dan-spacing-tiang-lampu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tinggi Tiang dan Spacing Lampu: Mengapa Tidak Ada Angka Universal**.
...
- `/jual-pasang-tiang-lampu-taman-tebing-tinggi.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-lampu-taman-tebing-tinggi` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-tebing-tinggi.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-tebing-tinggi` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-pju-tebing-tinggi.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-pju-tebing-tinggi` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `TPG-10-01` → `/artikel/memilih-sistem-tiang-lampu.html` — PJU, Lampu Taman, Floodlight, dan Solar: Memilih Sistem Tiang Lampu
...
- **Tie back to this article:** Keep the explanation specific to “Tinggi Tiang dan Spacing Lampu: Mengapa Tidak Ada Angka Universal”.
