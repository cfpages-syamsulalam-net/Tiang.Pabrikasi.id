...
title: "Survey Lokasi Tiang: Data yang Harus Dibawa Pulang"
slug: "survey-lokasi-tiang"
description: "Record coordinates, obstructions, terrain, access, utilities, drainage, exposure, photos, and unresolved risks"
status: outline
...
final_route: "/artikel/survey-lokasi-tiang.html"
...
# Survey Lokasi Tiang: Data yang Harus Dibawa Pulang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Survey Lokasi Tiang: Data yang Harus Dibawa Pulang”
- **Reader and situation:** Surveyor or project coordinator visiting a site
- **Reader outcome:** Record coordinates, obstructions, terrain, access, utilities, drainage, exposure, photos, and unresolved risks
...
- **Scope boundary:** Visual survey cannot establish soil capacity or hidden utilities; TPG-02-04 owns investigation scope
- **Final public route:** `/artikel/survey-lokasi-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Survey Lokasi Tiang: Data yang Harus Dibawa Pulang**.
...
- `/jual-pasang-tiang-traffic-light-pulang-pisau.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-pulang-pisau` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-pju-pulang-pisau.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-pju-pulang-pisau` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-penangkal-petir-pulang-pisau.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-penangkal-petir-pulang-pisau` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `TPG-02-01` → `/artikel/checklist-design-brief-tiang.html` — Checklist Data untuk Design Brief Tiang
...
- **Tie back to this article:** Keep the explanation specific to “Survey Lokasi Tiang: Data yang Harus Dibawa Pulang”.
