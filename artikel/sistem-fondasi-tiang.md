...
title: "Sistem Fondasi Tiang: Beban, Tanah, Anchor, dan Interface"
slug: "sistem-fondasi-tiang"
description: "Map reactions, soil response, base/embedded options, anchors, pedestal, drainage, tolerances, and discipline handoffs"
status: outline
publication_date: "2025-12-19"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-08
primary_intent: "Understand foundation coordination"
reader_community: "Pabrikasi.id"
reader_address: "Sobat Pabrikasi.id"
final_route: "/artikel/sistem-fondasi-tiang.html"
...
# Sistem Fondasi Tiang: Beban, Tanah, Anchor, dan Interface

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sistem Fondasi Tiang: Beban, Tanah, Anchor, dan Interface”
- **Reader and situation:** Owner tempted to reuse a standard footing
- **Reader outcome:** Map reactions, soil response, base/embedded options, anchors, pedestal, drainage, tolerances, and discipline handoffs
- **Primary intent:** Understand foundation coordination
...
- **Scope boundary:** No generic foundation size or safe soil capacity; geotechnical and structural design required
- **Final public route:** `/artikel/sistem-fondasi-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sistem Fondasi Tiang: Beban, Tanah, Anchor, dan Interface**.
...
- **Tie back to this article:** Keep the explanation specific to “Sistem Fondasi Tiang: Beban, Tanah, Anchor, dan Interface”.
