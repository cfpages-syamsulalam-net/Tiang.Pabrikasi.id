---
article_id: TPG-09-02
title: "Equipment Schedule Antena dan CCTV untuk Desain Tiang"
slug: "equipment-schedule-antena-cctv"
description: "Record device, bracket, cable, cabinet, orientation, mass, projected area, eccentricity, maintenance, and future allowance"
status: outline
publication_date: "2026-01-16"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-09
primary_intent: "Capture mounted-equipment inputs"
reader_community: "Pabrikasi.id"
reader_address: "Teman Pabrikasi.id"
final_route: "/artikel/equipment-schedule-antena-cctv.html"
...
# Equipment Schedule Antena dan CCTV untuk Desain Tiang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Equipment Schedule Antena dan CCTV untuk Desain Tiang”
- **Reader and situation:** Integrator sending data to a pole designer
- **Reader outcome:** Record device, bracket, cable, cabinet, orientation, mass, projected area, eccentricity, maintenance, and future allowance
- **Primary intent:** Capture mounted-equipment inputs
...
- **Scope boundary:** Does not calculate wind actions or approve equipment; TPG-03-02 owns structural input method
- **Final public route:** `/artikel/equipment-schedule-antena-cctv.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Equipment Schedule Antena dan CCTV untuk Desain Tiang**.
...
- **Exact Markdown to insert:** `![Ilustrasi Tiang Antena 4](/wp-content/uploads/2024/01/Tiang-Antena-4.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Tiang Antena 4` as relevant content media; no pixels were inspected.
...
- `/jual-pasang-tiang-cctv-yogyakarta.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-cctv-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-cctv-yalimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-cctv-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-cctv-yahukimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-cctv-yahukimo` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `TPG-09-01` → `/artikel/memilih-tiang-antena-cctv-telekomunikasi.html` — Memilih Sistem Tiang untuk Antena, CCTV, atau Perangkat Telekomunikasi
- `TPG-09-03` → `/artikel/getaran-tiang-cctv.html` — Getaran Tiang CCTV dan Dampaknya pada Kualitas Gambar
- `TPG-09-04` → `/artikel/line-of-sight-antena-dan-tiang.html` — Line of Sight Antena: Data yang Harus Dikoordinasikan dengan Tiang
...
- **Tie back to this article:** Keep the explanation specific to “Equipment Schedule Antena dan CCTV untuk Desain Tiang”.
