...
title: "Visual Inspection dan NDT Las Tiang: Memilih Metode yang Tepat"
slug: "inspeksi-ndt-las-tiang"
description: "Match visual, PT/MT, UT/RT, timing, access, defect type, extent, competence, and reporting to risk/specification"
status: outline
publication_date: "2025-11-12"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-06
primary_intent: "Plan weld examination"
reader_community: "Pabrikasi.id"
reader_address: "Sobat Pabrikasi.id"
final_route: "/artikel/inspeksi-ndt-las-tiang.html"
...
# Visual Inspection dan NDT Las Tiang: Memilih Metode yang Tepat

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Visual Inspection dan NDT Las Tiang: Memilih Metode yang Tepat”
- **Reader and situation:** QA team defining an ITP
- **Reader outcome:** Match visual, PT/MT, UT/RT, timing, access, defect type, extent, competence, and reporting to risk/specification
- **Primary intent:** Plan weld examination
...
- **Scope boundary:** No generic NDT percentage or acceptance criteria; project code/specification governs
- **Final public route:** `/artikel/inspeksi-ndt-las-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Visual Inspection dan NDT Las Tiang: Memilih Metode yang Tepat**.
...
- `TPG-06-03` → `/artikel/distorsi-pengelasan-tiang.html` — Mengendalikan Distorsi Pengelasan pada Shaft dan Flange
- `TPG-06-05` → `/artikel/cacat-las-tiang.html` — Cacat Las pada Tiang: Temuan, Penyebab, dan Eskalasi
- `TPG-06-06` → `/artikel/prosedur-repair-las-tiang.html` — Repair Las: Mengapa Gerinda dan Las Ulang Butuh Prosedur
...
- **Tie back to this article:** Keep the explanation specific to “Visual Inspection dan NDT Las Tiang: Memilih Metode yang Tepat”.
