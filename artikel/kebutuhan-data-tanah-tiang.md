...
title: "Kapan Proyek Tiang Membutuhkan Data Tanah?"
slug: "kebutuhan-data-tanah-tiang"
description: "Recognize site and load conditions that require investigation and define questions for a geotechnical professional"
status: outline
publication_date: "2025-08-13"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-02
primary_intent: "Decide geotechnical input level"
reader_community: "Pabrikasi.id"
reader_address: "Sobat Pabrikasi.id"
final_route: "/artikel/kebutuhan-data-tanah-tiang.html"
...
# Kapan Proyek Tiang Membutuhkan Data Tanah?

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kapan Proyek Tiang Membutuhkan Data Tanah?”
- **Reader and situation:** Owner unsure whether a generic footing is enough
- **Reader outcome:** Recognize site and load conditions that require investigation and define questions for a geotechnical professional
- **Primary intent:** Decide geotechnical input level
...
- **Scope boundary:** No soil classification from photos and no footing design; TPG-08-04 owns foundation use
- **Final public route:** `/artikel/kebutuhan-data-tanah-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kapan Proyek Tiang Membutuhkan Data Tanah?**.
...
- `TPG-02-02` → `/artikel/survey-lokasi-tiang.html` — Survey Lokasi Tiang: Data yang Harus Dibawa Pulang
- `TPG-02-03` → `/artikel/jadwal-peralatan-pada-tiang.html` — Cara Mendata Peralatan yang Akan Dipasang pada Tiang
- `TPG-02-05` → `/artikel/rencana-akses-perawatan-tiang.html` — Menentukan Akses Perawatan Sebelum Tiang Diproduksi
- `TPG-02-06` → `/artikel/register-asumsi-desain-tiang.html` — Register Asumsi dan Data Belum Ada pada Desain Tiang
...
- **Tie back to this article:** Keep the explanation specific to “Kapan Proyek Tiang Membutuhkan Data Tanah?”.
