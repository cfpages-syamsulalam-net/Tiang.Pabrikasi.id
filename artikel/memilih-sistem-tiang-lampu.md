---
article_id: TPG-10-01
title: "PJU, Lampu Taman, Floodlight, dan Solar: Memilih Sistem Tiang Lampu"
slug: "memilih-sistem-tiang-lampu"
description: "Compare task, optics, height, outreach, power source, equipment area, access, environment, and maintenance"
status: outline
publication_date: "2026-02-05"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-10
primary_intent: "Choose a lighting-pole application"
reader_community: "Pabrikasi.id"
reader_address: "Sobat Pabrikasi.id"
final_route: "/artikel/memilih-sistem-tiang-lampu.html"
...
# PJU, Lampu Taman, Floodlight, dan Solar: Memilih Sistem Tiang Lampu

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “PJU, Lampu Taman, Floodlight, dan Solar: Memilih Sistem Tiang Lampu”
- **Reader and situation:** Owner starting a lighting project
- **Reader outcome:** Compare task, optics, height, outreach, power source, equipment area, access, environment, and maintenance
- **Primary intent:** Choose a lighting-pole application
...
- **Scope boundary:** No photometric design, wattage, spacing, or pole sizing; transactional intent stays on lighting routes
- **Final public route:** `/artikel/memilih-sistem-tiang-lampu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **PJU, Lampu Taman, Floodlight, dan Solar: Memilih Sistem Tiang Lampu**.
...
- **Exact Markdown to insert:** `![Ilustrasi Tiang Lampu Taman 2](/wp-content/uploads/2024/01/Tiang-Lampu-Taman-2.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Tiang Lampu Taman 2` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “PJU, Lampu Taman, Floodlight, dan Solar: Memilih Sistem Tiang Lampu”.
