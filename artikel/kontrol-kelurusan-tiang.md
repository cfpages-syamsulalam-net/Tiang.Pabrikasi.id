...
title: "Straightness, Twist, dan Alignment pada Tiang"
slug: "kontrol-kelurusan-tiang"
description: "Define reference lines, measurement setup, flange orientation, twist, cumulative error, recording, and disposition"
status: outline
publication_date: "2025-10-21"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-05
primary_intent: "Inspect geometric conformance"
reader_community: "Pabrikasi.id"
reader_address: "Sobat Pabrikasi.id"
final_route: "/artikel/kontrol-kelurusan-tiang.html"
...
# Straightness, Twist, dan Alignment pada Tiang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Straightness, Twist, dan Alignment pada Tiang”
- **Reader and situation:** QA team measuring a segment or assembly
- **Reader outcome:** Define reference lines, measurement setup, flange orientation, twist, cumulative error, recording, and disposition
- **Primary intent:** Inspect geometric conformance
...
- **Scope boundary:** No generic acceptance numbers; use project drawing/specification
- **Final public route:** `/artikel/kontrol-kelurusan-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Straightness, Twist, dan Alignment pada Tiang**.
...
- `TPG-05-01` → `/artikel/alur-pabrikasi-tiang.html` — Alur Pabrikasi Tiang dari Drawing hingga Release
...
- **Tie back to this article:** Keep the explanation specific to “Straightness, Twist, dan Alignment pada Tiang”.
