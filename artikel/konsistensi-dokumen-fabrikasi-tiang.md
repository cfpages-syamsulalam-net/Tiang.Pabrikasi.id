---
article_id: TPG-16-03
title: "Dokumen Material, Welding, dan Coating yang Harus Konsisten"
slug: "konsistensi-dokumen-fabrikasi-tiang"
description: "Trace grade/heat/part, drawing, WPS/welder, weld/NDT, coating system/batch/measurement, repair, and release across records"
status: outline
publication_date: "2026-07-16"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-16
primary_intent: "Cross-check fabrication evidence"
reader_community: "Pabrikasi.id"
reader_address: "Teman Pabrikasi.id"
final_route: "/artikel/konsistensi-dokumen-fabrikasi-tiang.html"
...
- **Writer task:** Expand this file into one complete article answering: “Dokumen Material, Welding, dan Coating yang Harus Konsisten”
- **Reader and situation:** QA reviewer receiving separate certificates/reports
- **Reader outcome:** Trace grade/heat/part, drawing, WPS/welder, weld/NDT, coating system/batch/measurement, repair, and release across records
- **Primary intent:** Cross-check fabrication evidence
...
- **Scope boundary:** Does not validate authenticity or acceptance without source checks and applicable specification
- **Final public route:** `/artikel/konsistensi-dokumen-fabrikasi-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Dokumen Material, Welding, dan Coating yang Harus Konsisten**.
...
- **Exact Markdown to insert:** `![Ilustrasi Material Tiang](/wp-content/uploads/2024/01/Material-Tiang.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Material Tiang` as relevant content media; no pixels were inspected.
...
- `/jual-pasang-tiang-traffic-light-yogyakarta.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-yalimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-yahukimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-yahukimo` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `TPG-16-01` → `/artikel/membandingkan-penawaran-tiang.html` — Checklist Membandingkan Penawaran Tiang Secara Apple-to-Apple
- `TPG-16-02` → `/artikel/submittal-register-proyek-tiang.html` — Submittal Register untuk Proyek Tiang
- `TPG-16-04` → `/artikel/itp-pabrikasi-tiang.html` — Inspection and Test Plan Pabrikasi Tiang
- `TPG-16-05` → `/artikel/scope-matrix-proyek-tiang.html` — Scope Matrix Supply, Fondasi, Erection, dan Electrical Work
...
- **Tie back to this article:** Keep the explanation specific to “Dokumen Material, Welding, dan Coating yang Harus Konsisten”.
