---
article_id: TPG-15-03
title: "Karat pada Tiang: Membedakan Noda, Coating Rusak, dan Kehilangan Penampang"
slug: "diagnosis-korosi-tiang"
description: "Distinguish evidence categories, locations, moisture sources, cleaning limits, measurement/escalation, and repair specification needs"
status: outline
publication_date: "2026-06-23"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-15
primary_intent: "Triage corrosion observations"
reader_community: "Pabrikasi.id"
reader_address: "Sobat Pabrikasi.id"
final_route: "/artikel/diagnosis-korosi-tiang.html"
...
# Karat pada Tiang: Membedakan Noda, Coating Rusak, dan Kehilangan Penampang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Karat pada Tiang: Membedakan Noda, Coating Rusak, dan Kehilangan Penampang”
- **Reader and situation:** Maintainer documenting rust or coating failure
- **Reader outcome:** Distinguish evidence categories, locations, moisture sources, cleaning limits, measurement/escalation, and repair specification needs
- **Primary intent:** Triage corrosion observations
...
- **Scope boundary:** Photos cannot quantify residual capacity or authorize repair
- **Final public route:** `/artikel/diagnosis-korosi-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Karat pada Tiang: Membedakan Noda, Coating Rusak, dan Kehilangan Penampang**.
...
- `TPG-15-01` → `/artikel/program-inspeksi-tiang.html` — Program Inspeksi Tiang Berbasis Risiko
- `TPG-15-02` → `/artikel/pemeriksaan-tiang-miring.html` — Tiang Miring: Cara Mencatat Temuan Sebelum Menyimpulkan Penyebab
- `TPG-15-04` → `/artikel/diagnosis-getaran-tiang.html` — Tiang Bergetar atau Bergoyang: Urutan Pemeriksaan yang Aman
- `TPG-15-05` → `/artikel/repair-strengthening-ganti-tiang.html` — Repair, Strengthening, atau Ganti Tiang?
...
- **Tie back to this article:** Keep the explanation specific to “Karat pada Tiang: Membedakan Noda, Coating Rusak, dan Kehilangan Penampang”.
