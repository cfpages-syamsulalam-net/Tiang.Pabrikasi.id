---
article_id: TPG-15-04
title: "Tiang Bergetar atau Bergoyang: Urutan Pemeriksaan yang Aman"
slug: "diagnosis-getaran-tiang"
description: "Separate weather/equipment/connection/foundation possibilities, record conditions, set exclusion/escalation, and define specialist measurements"
status: outline
publication_date: "2026-06-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-15
primary_intent: "Triage unexpected motion"
reader_community: "Pabrikasi.id"
reader_address: "Kawan Pabrikasi.id"
final_route: "/artikel/diagnosis-getaran-tiang.html"
...
# Tiang Bergetar atau Bergoyang: Urutan Pemeriksaan yang Aman

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tiang Bergetar atau Bergoyang: Urutan Pemeriksaan yang Aman”
- **Reader and situation:** Operator observing movement
- **Reader outcome:** Separate weather/equipment/connection/foundation possibilities, record conditions, set exclusion/escalation, and define specialist measurements
- **Primary intent:** Triage unexpected motion
...
- **Scope boundary:** No safety verdict or field modification from video/observation
- **Final public route:** `/artikel/diagnosis-getaran-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tiang Bergetar atau Bergoyang: Urutan Pemeriksaan yang Aman**.
...
- **Tie back to this article:** Keep the explanation specific to “Tiang Bergetar atau Bergoyang: Urutan Pemeriksaan yang Aman”.
