...
title: "Access Door Tiang: Bukaan Kecil dengan Dampak Struktur Besar"
slug: "desain-access-door-tiang"
description: "Understand opening position, reinforcement, edge detail, cover, lock, water entry, cable clearance, and inspection"
status: outline
publication_date: "2025-10-01"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-04
primary_intent: "Specify an access opening"
reader_community: "Pabrikasi.id"
reader_address: "Sobat Pabrikasi.id"
final_route: "/artikel/desain-access-door-tiang.html"
...
# Access Door Tiang: Bukaan Kecil dengan Dampak Struktur Besar

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Access Door Tiang: Bukaan Kecil dengan Dampak Struktur Besar”
- **Reader and situation:** Lighting/electrical pole coordinator
- **Reader outcome:** Understand opening position, reinforcement, edge detail, cover, lock, water entry, cable clearance, and inspection
- **Primary intent:** Specify an access opening
...
- **Scope boundary:** No opening size/location approval; structural and electrical designers coordinate
- **Final public route:** `/artikel/desain-access-door-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Access Door Tiang: Bukaan Kecil dengan Dampak Struktur Besar**.
...
- `/jual-pasang-tiang-traffic-light-aceh-besar.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-traffic-light-aceh-besar` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-pju-aceh-besar.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-pju-aceh-besar` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-penangkal-petir-aceh-besar.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-penangkal-petir-aceh-besar` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `TPG-04-02` → `/artikel/bentuk-penampang-tiang.html` — Penampang Bulat, Polygonal, dan Hollow untuk Tiang
- `TPG-04-03` → `/artikel/jenis-sambungan-segmen-tiang.html` — Sambungan Flange, Slip Joint, Spigot, dan Baut pada Tiang
- `TPG-04-05` → `/artikel/traceability-material-tiang.html` — Traceability Material Tiang dari Sertifikat hingga Marking
- `TPG-04-06` → `/artikel/korosi-galvanik-sambungan-tiang.html` — Korosi Galvanik Saat Material Berbeda Bertemu pada Tiang
...
- **Tie back to this article:** Keep the explanation specific to “Access Door Tiang: Bukaan Kecil dengan Dampak Struktur Besar”.
