---
article_id: TPG-16-02
title: "Submittal Register untuk Proyek Tiang"
slug: "submittal-register-proyek-tiang"
description: "Index design basis, calculations, drawings, materials, welding, coating, fabrication, installation, testing, O&M, as-builts, revisions, and status"
status: outline
...
final_route: "/artikel/submittal-register-proyek-tiang.html"
...
# Submittal Register untuk Proyek Tiang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Submittal Register untuk Proyek Tiang”
- **Reader and situation:** Consultant/owner controlling approvals
- **Reader outcome:** Index design basis, calculations, drawings, materials, welding, coating, fabrication, installation, testing, O&M, as-builts, revisions, and status
...
- **Scope boundary:** A submitted document is not automatically approved or compliant
- **Final public route:** `/artikel/submittal-register-proyek-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Submittal Register untuk Proyek Tiang**.
...
- **Tie back to this article:** Keep the explanation specific to “Submittal Register untuk Proyek Tiang”.
