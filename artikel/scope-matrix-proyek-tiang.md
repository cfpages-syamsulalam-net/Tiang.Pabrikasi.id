---
article_id: TPG-16-05
title: "Scope Matrix Supply, Fondasi, Erection, dan Electrical Work"
slug: "scope-matrix-proyek-tiang"
description: "Assign design, permits, survey, supply, anchors, civil, transport, crane, erection, cabling, testing, defects, and handover interfaces"
status: outline
publication_date: "2026-07-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-16
primary_intent: "Eliminate scope gaps"
reader_community: "Pabrikasi.id"
reader_address: "Teman Pabrikasi.id"
final_route: "/artikel/scope-matrix-proyek-tiang.html"
...
# Scope Matrix Supply, Fondasi, Erection, dan Electrical Work

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Scope Matrix Supply, Fondasi, Erection, dan Electrical Work”
- **Reader and situation:** Multi-contractor project splitting work packages
- **Reader outcome:** Assign design, permits, survey, supply, anchors, civil, transport, crane, erection, cabling, testing, defects, and handover interfaces
- **Primary intent:** Eliminate scope gaps
...
- **Scope boundary:** Not a contract or legal allocation; parties must approve project terms
- **Final public route:** `/artikel/scope-matrix-proyek-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Scope Matrix Supply, Fondasi, Erection, dan Electrical Work**.
...
- `TPG-16-03` → `/artikel/konsistensi-dokumen-fabrikasi-tiang.html` — Dokumen Material, Welding, dan Coating yang Harus Konsisten
- `TPG-16-04` → `/artikel/itp-pabrikasi-tiang.html` — Inspection and Test Plan Pabrikasi Tiang
- `TPG-16-06` → `/artikel/handover-dossier-tiang.html` — Handover Dossier Tiang: Isi, Struktur, dan Cara Audit
...
- **Tie back to this article:** Keep the explanation specific to “Scope Matrix Supply, Fondasi, Erection, dan Electrical Work”.
