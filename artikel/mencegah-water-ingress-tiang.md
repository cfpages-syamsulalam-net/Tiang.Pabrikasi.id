---
article_id: TPG-13-04
title: "Water Ingress pada Access Door dan Jalur Kabel Tiang"
slug: "mencegah-water-ingress-tiang"
description: "Trace covers, seals, orientation, conduit, condensation, drainage, corrosion, electrical risk, inspection, and escalation"
status: outline
publication_date: "2026-05-05"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-13
primary_intent: "Prevent and diagnose water entry"
reader_community: "Pabrikasi.id"
reader_address: "Sobat Pabrikasi.id"
final_route: "/artikel/mencegah-water-ingress-tiang.html"
...
# Water Ingress pada Access Door dan Jalur Kabel Tiang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Water Ingress pada Access Door dan Jalur Kabel Tiang”
- **Reader and situation:** Operator finding moisture inside a pole
- **Reader outcome:** Trace covers, seals, orientation, conduit, condensation, drainage, corrosion, electrical risk, inspection, and escalation
- **Primary intent:** Prevent and diagnose water entry
...
- **Scope boundary:** No IP claim or energized-work instruction; isolate and use competent electrical personnel
- **Final public route:** `/artikel/mencegah-water-ingress-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Water Ingress pada Access Door dan Jalur Kabel Tiang**.
...
- `TPG-13-03` → `/artikel/bonding-pada-tiang-berlapis.html` — Detail Bonding pada Tiang Berlapis dan Sambungan Baut
- `TPG-13-05` → `/artikel/test-record-earthing-bonding.html` — Test Record Earthing dan Bonding Saat Commissioning Tiang
- `TPG-13-06` → `/artikel/drawing-interface-elektrikal-tiang.html` — Single-Line dan Interface Drawing untuk Sistem Tiang
...
- **Tie back to this article:** Keep the explanation specific to “Water Ingress pada Access Door dan Jalur Kabel Tiang”.
