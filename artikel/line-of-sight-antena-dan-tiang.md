---
article_id: TPG-09-04
title: "Line of Sight Antena: Data yang Harus Dikoordinasikan dengan Tiang"
slug: "line-of-sight-antena-dan-tiang"
description: "Define endpoints, terrain/obstructions, equipment elevation, orientation, maintenance, future obstruction, and documentation"
status: outline
publication_date: "2026-01-23"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPG-09
primary_intent: "Coordinate antenna sightline requirements"
reader_community: "Pabrikasi.id"
reader_address: "Sobat Pabrikasi.id"
final_route: "/artikel/line-of-sight-antena-dan-tiang.html"
...
# Line of Sight Antena: Data yang Harus Dikoordinasikan dengan Tiang

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Line of Sight Antena: Data yang Harus Dikoordinasikan dengan Tiang”
- **Reader and situation:** Network planner and pole designer exchanging inputs
- **Reader outcome:** Define endpoints, terrain/obstructions, equipment elevation, orientation, maintenance, future obstruction, and documentation
- **Primary intent:** Coordinate antenna sightline requirements
...
- **Scope boundary:** Does not perform RF/link-budget design or promise connectivity
- **Final public route:** `/artikel/line-of-sight-antena-dan-tiang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Line of Sight Antena: Data yang Harus Dikoordinasikan dengan Tiang**.
...
- **Exact Markdown to insert:** `![Ilustrasi Tiang Antena 8](/wp-content/uploads/2024/01/Tiang-Antena-8.png)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Tiang Antena 8` as relevant content media; no pixels were inspected.
...
- `/jual-pasang-tiang-antena-yogyakarta.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-antena-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-antena-yalimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-antena-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-antena-yahukimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-pasang-tiang-antena-yahukimo` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `TPG-09-02` → `/artikel/equipment-schedule-antena-cctv.html` — Equipment Schedule Antena dan CCTV untuk Desain Tiang
- `TPG-09-03` → `/artikel/getaran-tiang-cctv.html` — Getaran Tiang CCTV dan Dampaknya pada Kualitas Gambar
- `TPG-09-05` → `/artikel/routing-kabel-tiang-cctv-telekomunikasi.html` — Routing Kabel pada Tiang CCTV dan Telekomunikasi
- `TPG-09-06` → `/artikel/menambah-perangkat-tiang-existing.html` — Menambah Perangkat pada Tiang Existing: Data Sebelum Bilang “Masih Muat”
...
- **Tie back to this article:** Keep the explanation specific to “Line of Sight Antena: Data yang Harus Dikoordinasikan dengan Tiang”.
